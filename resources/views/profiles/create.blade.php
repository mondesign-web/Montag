...
@section('content')
    ...
    <div class="container mx-auto">
        ...
        <div class="border-b border-gray-200 px-1 sm:px-4 pt-6">
            <nav class="flex justify-between" id="tabs">
                ...
                <button
                    ...
                    <p class="pl-2"> Contact Details </p>
                </button>
                <button
                    class="flex items-center tab-btn px-1 py-2 text-sm font-medium text-gray-600 hover:text-blue-600 border-b-2 border-transparent">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <form action="{{ route('profiles.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="col-span-4 sm:col-span-8 tab-content hidden">
                ...
                <div class="border-dashed border-2 p-6 my-6 border-gray-300 rounded-md">
                    ...
                    <!-- Add Links -->
                    <div>
                        <label for="content-link" class="block text-sm font-medium text-gray-700 mb-2">Ajouter un
                            lien:</label>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center space-x-4 mt-2">
                            <input type="file" name="documents[]" id="file"
                                class="w-full border px-4 py-2 rounded" accept="application/pdf" oninput="updatePreview('pdf_', this.value)"
                                onchange="validatePDFSize(this)" />
                            <p id="file-error" class="text-red-500 text-sm hidden">Le fichier ne doit pas dépasser 5MB.</p>
                            <!--input type="file" name="documents[]" id="file"
            ...
            <div class="col-span-4 sm:col-span-4">
                <div
                    class="max-w-2xl  sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900">
                    ...
                    <ul class="mb-6 md:mb-0 ml-4 mr-2">
                        <li class="flex my-2">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400" id="address_">1230 Maecenas Street Donec</p>
