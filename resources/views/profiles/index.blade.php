...
@section('content')
    <div class="flex flex-col m-8">
        <h1 class="text-2xl font-bold text-center mb-6">Mes Profils</h1>
        <div class="flex items-center justify-between">
            <a href="{{ route('profiles.index') }}" class="mb-4">
                <button class="flex h-12 w-12 items-center justify-center rounded bg-blue-600 text-white ">
            ...
            <form method="GET" action="{{ route('profiles.index') }}" class="flex items-center gap-2">
                ...
                <div class="relative mb-4">
                    ...
                    <!--svg class="absolute top-1/2 left-3 transform -translate-y-1/2 w-5 h-5 text-gray-400"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 16l-4-4m0 0l4-4m-4 4h16m-5 4v-8" />
                            </svg-->
                </div>

                <!-- Bouton pour rechercher -->
                <button type="submit"
                    class="p-3 mb-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M21 21l-4.35-4.35M9 17a8 8 0 1 0 0-16 8 8 0 0 0 0 16z" />
                    </svg>
                </button>
            </form>
        </div>
            ...
            <div class="min-w-full inline-block align-middle">
                @if (session('success'))
                    <div id="dismiss-alert"
                        class="hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 bg-teal-50 border border-teal-300 text-sm text-teal-800 rounded-lg p-4 my-3 dark:bg-teal-800/10 dark:border-teal-900 dark:text-teal-500"
                                    ...
                                    <td class=" px-5 py-3">
                                        <div class="w-48 flex items-center gap-3">
                                            <img src="{{ asset('storage/' . $profile->photo_url ?? 'default-photo.png') }}"
                                                alt="Floyd image" width="30" height="30" class="rounded-full">
                                            <div class="data">
