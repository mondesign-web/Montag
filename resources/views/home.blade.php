            ...
            <!--div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            <div class="p-3 mr-4 text-green-500 bg-green-100 rounded-full">
                                <svg fill="#22c55e" width="25px" height="25px" viewBox="-3.5 0 32 32" version="1.1"
                                    ...
                                    <path
                                        d="M12.406 13.844c1.188 0 2.156 0.969 2.156 2.156s-0.969 2.125-2.156 2.125-2.125-0.938-2.125-2.125 0.938-2.156 2.125-2.156z">
                                    </path>
                                </svg>
                            </div>
                            <div>
                                <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Profile Views</p>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            <div class="p-3 mr-4 text-blue-500 bg-blue-100 rounded-full">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892"></path>
                                </svg>
                            </div>
                            <div>
                                <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Contact Exchanged</p>
                                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                                    {{ $insights->contact_exchanged ?? 0 }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            <div class="p-3 mr-4 text-purple-500 bg-purple-100 rounded-full">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path>
                                </svg>
                            </div>
                            <div>
                                <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Contact Downloads</p>
                                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                                    {{ $insights->contact_downloads ?? 0 }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            <div class="p-3 mr-4 text-yellow-500 bg-yellow-100 rounded-full">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2z"></path>
                                </svg>
                            </div>
                            <div>
                                <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Link Taps</p>
                                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                                    {{ $insights->link_taps ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div-->
                            ...
                            <tbody class="divide-y divide-gray-300 ">
                                @foreach ($profiles as $profile)
                                    ...
                                    <!--tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                                                                                    ...
                                                                                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Partner
                                                                                                    </td>
                                                                                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Electronics
                                                                                                    </td>
                                                                                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Feb. 23,
                                                                                                        2023 </td>
